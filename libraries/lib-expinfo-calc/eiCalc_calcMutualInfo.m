function midata = eiCalc_calcMutualInfo( ...
...
%   bin_count_dest, bin_count_src, exparams, phase_params )
%
% This calculates time-lagged mutual information between pairs of channels
...
% Repackage analysis configuration parameters.
...
if want_phase
  midata = eiCalc_doTimeAndLagAnalysis( ...
    ftdata_dest, ftdata_src, win_params, flags, ...
    {}, @eiCalc_helper_analyzeMutual, analysis_params, ...
