function xcorrdata = eiCalc_calcXCorr( ...
...
if want_phase
  ...
  xcorrdata = eiCalc_doTimeAndLagAnalysis( ...
    ftdata_dest, ftdata_src, win_params, flags, ...
    preproc_config, @eiCalc_helper_analyzeXCorr, analysis_params, ...
    [ preproc_config, {'angle'} ], @eiCalc_helper_filterPhase, phase_params );
