...
%
%   "pairmask" is a boolean matrix indexed by (dest, src) that's true for
%     channel pairs that aren't self-comparisons, aren't permutations, aren't
%     squashed, and have desired sources and destinations.
%
